...
function SignInPage4({ password, confirmpassword, handlePassword, setConfirmPassword, setPage }) {
  return (
    <>
      ...
      <Box sx={{ width: "100%" }}>
        ...
        <Box sx={{ display: "flex", justifyContent: "space-between" }}>
          ...
          <Button variant="contained" sx={{ backgroundColor: "#1A73E8" }}>Sign Up</Button>
        </Box>
      </Box>
    </>
  );
